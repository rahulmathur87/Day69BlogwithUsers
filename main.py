...
def get_all_posts():
    ...
    return render_template("index.html", all_posts=posts, current_user=current_user.is_authenticated)
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, current_user=current_user.is_authenticated)
